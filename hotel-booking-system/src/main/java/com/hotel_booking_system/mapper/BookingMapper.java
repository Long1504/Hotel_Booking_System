...
@Mapper(componentModel = "spring", uses = {BookingStatusHistoryMapper.class, RoomMapper.class, BookingServiceMapper.class})
public interface BookingMapper {
    BookingResponse toBookingResponse(Booking booking);

    SendBookingEmailRequest toSendBookingEmailRequest(Booking booking);
}
